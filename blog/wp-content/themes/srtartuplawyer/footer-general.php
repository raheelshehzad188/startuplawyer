		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<h3 data-target="#collapse_1" data-toggle="collapse" class="collapsed" aria-expanded="false">Quick Links</h3>
					...
					<div class="collapse dont-collapse-sm links" id="collapse_1">
						...
						<ul>
							...
							<li><a href="<?= site_url(); ?>/privacy-security/">Privacy & Security</a></li>

							<li><a href="<?= site_url(); ?>/refund-policy/">Refund Policy</a></li>

							<li><a href="<?= site_url(); ?>/who-we-are/">Who we are</a></li>

							<li><a href="<?= site_url(); ?>/my-account-2/">My Account</a></li>

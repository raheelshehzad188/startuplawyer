	...
	<table class="woocommerce-table woocommerce-table--order-downloads shop_table shop_table_responsive order_details">
		<thead>
			<tr>
				...
				{
				    ?>
				    <th class="sp_name"><span class="nobr">Service Provider</span></th>
				    <?php
				}
				?>
				<?php endforeach; ?>
							...
							switch ( $column_id ) {
								case 'download-product':
									if ( $download['product_url'] ) {
										echo '<a href="' . esc_url( $download['product_url'] ) . '">' . esc_html( $download['product_name'] ) . '</a></td><td>';
								// 		var_dump($download['product_id']);
										$pid = $download['product_id'];

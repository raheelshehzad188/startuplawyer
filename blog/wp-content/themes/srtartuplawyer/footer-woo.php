...
?>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<h3 data-target="#collapse_2" data-toggle="collapse" class="collapsed" aria-expanded="false">Ask Any Question </h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="collapse dont-collapse-sm contacts" id="collapse_3">
						...
						<ul>
							...
							<li><i class="icon_mobile"></i><?php ot_get_option( 'contact_phone', '+94 423-23-221' ); ?></li>

							<li><i class="icon_mail_alt"></i><a href="#0"><?php ot_get_option( 'contact_mail', 'info@domain.com' ); ?></a></li>
    ...
    color: white;
    background: #142954;
    padding: 8px 13px;" class="fa fa-twitter"></i></a></li>
								<li><a href="#0"><i style="    font-size: 21px;
    color: white;
    background: #142954;

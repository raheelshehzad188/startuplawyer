...
class Option extends CI_Controller {
		...
		$this->Common_model->table = 'wp_options';
		$this->Common_model->key = 'option_id';
		$this->modal = $this->Common_model;
		$this->url = base_url().'/admin/option';
...
// 		print_r($data['locations']);
	...
	{
        $this->form_validation->set_rules('option_name', $this->single.' Key', 'required');$this->form_validation->set_rules('option_value', $this->single.' Value', 'required');

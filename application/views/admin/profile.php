                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                <form action="<?= base_url('admin/admin/profile'); ?>/<?= isset($user->ID)?$user->ID:''; ?>?general=1"  method="post" enctype="multipart/form-data" novalidate>
                                                <div class="media">
                                                    <a href="javascript: void(0);">
                                                        <img id="prof_img" src="<?= $uimg; ?>" class="rounded mr-75" alt="profile image" height="64" width="64">
                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label for="account-username">Banner image</label>
                                                                    <input type="file" class="form-control" name="banner" id="account-username" placeholder="Username" value="" readonly = "true">
                                                                    <img id="prof_img" src="<?= $user->banner; ?>" class="rounded mr-75" alt="profile Banner" height="64" width="64">
                                                                    <p class="text-muted ml-75 mt-50"><small>Allowed JPG, GIF or PNG. Max
                                                                Dimension should be  800 x450
                                                                </small></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="account-vertical-bank" aria-labelledby="account-pill-bank" aria-expanded="true">
                                                <form action="<?= base_url('admin/admin/profile'); ?>/<?= isset($user->ID)?$user->ID:''; ?>?bank=1"  method="post" enctype="multipart/form-data" novalidate>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                            ...
                                            <div class="tab-pane fade " id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                                <form action="<?= base_url('admin/admin/profile'); ?>/<?= isset($user->ID)?$user->ID:''; ?>?chpass=1"  method="post" enctype="multipart/form-data" novalidate>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label for="account-new-password">Current Password</label>
                                                                    <input type="password" name="npass" id="account-new-password" class="form-control" placeholder="Current Password" required data-validation-required-message="The password field is required" minlength="6">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="controls">
                                            ...
                                            <div class="tab-pane fade" id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                                                <form action="<?= base_url('admin/admin/profile'); ?>/<?= isset($user->ID)?$user->ID:''; ?>?bio=1"  method="post" enctype="multipart/form-data" novalidate>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="accountTextarea">Service provider policy</label>
                                                                <textarea class="form-control" name="sp-policy" id="account-pill-policy" rows="3" placeholder="Service provider policy..."><?=$product->getmeta('user',$user->ID,'description',true); ?></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="wp-tab-panel">
                                                                    ...
                                                                    $modal->table = 'wp_posts';
                                                $modal->key = 'ID';
                                                $recent_posts = $modal->get(array("post_type"=>'area'));
                                                ...
                                                <?php
                                                                    ...
                                                                    $modal->table = 'wp_posts';
                                                $modal->key = 'ID';
                                                $recent_posts = $modal->get(array("post_type"=>'distric'));
                                            ...
                                            <?php endforeach;?>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <span>Put only youtube video ID, Example: https://www.youtube.com/watch?v=HmZKgaHa3Fg in trhat ink HmZKgaHa3Fg is video id.</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" value="<?= $product->getmeta('user',$user->ID,'billing_email', true); ?>" name="billing_email" id="email" placeholder="Your email">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="working-hours" placeholder="Working hours">
                                                                
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="price-rangr">Price Range</label>
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                // document.getElementById('prof_img').style.backgroundImage="url( " + e.target.result + ")";
            }

                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td class="product-name"><?= $value['option_name'] ?></td>
                                    <td class="product-name"><?= $value['option_value'] ?></td>
                                    <td class="product-action">
                                        <a href="<?= $url.'/create/'.$value['option_id'];?>">
                                            <span class="action-edit"><i class="feather icon-edit"></i></span>
                                        </a>
                                        <a href="<?= $url.'/delete/'.$value['option_id'];?>">

...
<style>
    .search-results-lawyer,.filters_header{
        display:none;
    }
    .result_div{
     display:block;   
    }
    .col-sm-12.search-results-lawyer.content_day.loader_div img {
        width: 123px;
        position: relative;
        left: 43%;
        top: 35%;
...
?>
		...
		<form id="filter_form" action="<?= base_url('index/page'); ?>/search_ajax">
			...
			<input type="hidden" name="cate" value="<?= isset($_REQUEST["cate"])?$_REQUEST["cate"]:""; ?>"/>
			...
			<input type="hidden" name="min_price" id="min_price" value="<?= (isset($_REQUEST["min_price"])?$_REQUEST["min_price"]:""); ?>">
			<input type="hidden" name="max_price" id="max_price" value="<?= (isset($_REQUEST["max_price"])?$_REQUEST["max_price"]:""); ?>">
		</form>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-8 col-lg-7 col-md-7 d-none d-md-block">
						...
						<!--<h1>145 Webinars in all Languages by Lawyer</h1>-->
					</div>
					<div class="col-xl-4 col-lg-5 col-md-5">
						<div class="search_bar_list">
							<input type="text"  id="srch" class="form-control" placeholder="KEY WORD SEARCH">
							<input type="submit" onclick="load_filter()" value="Search" style="background: #182f61;">
						</div>
					</div>
				</div>
				<!-- /row -->		       
				...
				<div class="col-lg-9 full_lowyer_days ">
					<div class="col-sm-12 head" id="sticky_head">
						<div class="row">
							...
							<div class="col col-md-6 small-hide" style="padding: 0; display:none;">
					...
					<div class="col-sm-12 search-results-lawyer content_day result_div row">
					</div>
				</div>

...
<body>
    <div  class="icon text-center">
        <i class="feather icon-check" style="font-size: 62px;border: 7px solid;text-align: center;border-radius: 58px;color: green;    position: absolute;top: 50%;left: 50%;transform: translate(-50px, -50px);"></i> 

...
$assets = base_url('assets/booking/');
?>
<html lang="en">
<head>
	<meta charset="utf-8">
				...
				<div class="row">
					...
					<div class="col-xl-4 col-lg-5 col-md-5">
						<div class="search_bar_list">
							<input type="text" class="form-control"id="srch" placeholder="Search again...">
							<input type="submit" onclick="load_filter()" value="Search">
						</div>
					</div>
				</div>
				<!-- /row -->		       
                    ...
                    if($post)
                    {
                        ...
                        else
                        {
                            echo ' /'.$post->post_title.' ';
									...
									<div class="lawfirm">
										<a href="<?= base_url('/index/profile'); ?>/<?= $user->user_login; ?>" target="_blank">Check CV <i class="fa fa-external-link"></i></a>
									</div>
								</div>
							</div>
						</div>

...
<body>
	...
	<main>
		    ...
		    <div class="row">
		        <div class="col-lg-8">
		            ...
		            <div class="owl-carousel owl-theme carousel_1 magnific-gallery">
		                <div class="item">
		                    <a href="img/location_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/detail_1.jpg" alt=""></a>
		                </div>
		                <div class="item">
		                    <a href="img/location_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/lazy-placeholder-detail.png" data-src="<?= $url ?>img/detail_2.jpg" class="owl-lazy" alt=""></a>
		                </div>
		                <div class="item">
		                    <a href="img/location_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/lazy-placeholder-detail.png" data-src="<?= $url ?>img/detail_3.jpg" class="owl-lazy" alt=""></a>
		                </div>
		            </div>
		            <!-- /carousel -->
		            ...
		            <div class="tabs_detail">
		                <ul class="nav nav-tabs" role="tablist">
		                    <li class="nav-item">
		                        <a id="tab-A" href="#pane-A" class="nav-link active show" data-toggle="tab" role="tab">Information</a>
		                    </li>
		                    <li class="nav-item">
        ...
        $section = array(
            ...
            'Overview' => $pro->short_disc,
            'Details' => $pro->long_disc,
            );
            $i = 0;
        ...
        <a role="button" aria-expanded="false" id="<?= $sect ?>_a" onclick="detail_collapse('<?= $sect ?>');">
          <?= $name; ?>
        </a>
      </h4>
      </div>
      <div id="<?= $sect ?>" class="<?= ($i == 1)?"show":"hide"; ?>">
      ...
      <hr>
        ...
        ?>
		                                ...
		                                <div class="pictures magnific-gallery clearfix">
		                                    <figure><a href="img/detail_gallery/detail_1.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/thumb_detail_placeholder.jpg" data-src="<?= $url ?>img/thumb_detail_1.jpg" class="lazy" alt=""></a></figure>
		                                    <figure><a href="img/detail_gallery/detail_2.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/thumb_detail_placeholder.jpg" data-src="<?= $url ?>img/thumb_detail_2.jpg" class="lazy" alt=""></a></figure>
		                                    <figure><a href="img/detail_gallery/detail_3.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/thumb_detail_placeholder.jpg" data-src="<?= $url ?>img/thumb_detail_3.jpg" class="lazy" alt=""></a></figure>
		                                    <figure><a href="img/detail_gallery/detail_4.jpg" title="Photo title" data-effect="mfp-zoom-in"><img src="<?= $url ?>img/thumb_detail_placeholder.jpg" data-src="<?= $url ?>img/thumb_detail_4.jpg" class="lazy" alt=""></a></figure>
		                                    <figure><a href="img/detail_gallery/detail_5.jpg" title="Photo title" data-effect="mfp-zoom-in"><span class="d-flex align-items-center justify-content-center">+10</span><img src="<?= $url ?>img/thumb_detail_placeholder.jpg" data-src="<?= $url ?>img/thumb_detail_5.jpg" class="lazy" alt=""></a></figure>
		                                </div>
		                                <!-- /pictures -->

...
$rate = $product->get_user_rate(112);
?>
...

{
    ...
    <div class="item">
					<div class="strip_info str-info">
                        ...
                        <?php
     $post = $pro;
$recent_author = $product->getuser($post->post_author);
$dead_line = $product->getmeta('post',$pro->ID,'dead_line',true);
    	$terms = $pro->category;
    	$all_cat = array();
...
?>
		        ...
		        <div class="col-lg-4" id="sidebar_fixed">
		            ...
		            <div class="sku_no" >SKU : <?= $product->getmeta('post',$pro->ID,'_sku',true); ?></div>

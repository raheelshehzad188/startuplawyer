...
class Videos extends CI_Controller {
    ...
    //variables
    private $single= 'Video';
    private $multi= 'Videos';
    private $add= 'addptype';
    private $all= 'allptype';
    private $post_type= 'videos';
    private $url= '';
    private $modal= '';
	/**
  ...
  'post_type'=>$this->post_type
		...
		$this->Common_model->key = 'ID';
        	if($id)
        	{
        		$in['ID'] = $id;
        	        ...
        	        $this->Common_model->update($id,$in);
        	     $pid = $id;
        		if($pid)
	        	{
		...
		$modal = $this->Common_model;
	        		...
	        		$r = $product->updatemeta('post',$pid,'_thumbnail_id',$mediaID);
	        		}
	        	}
	        }
        }

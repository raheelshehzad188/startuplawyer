...
class Templates extends CI_Controller {
		...
		$this->url = base_url().'/admin/templates';
		$this->load->model('auth_model');
    }
    //variables
    private $single= 'Email Template';
    private $multi= 'Email Templates';
    private $add= 'addtemplate';
    private $post_type= 'email_templates';
...
// 		print_r($data['locations']);
  ...
  //
        	    ...
        	    if($pid)
        	    {
	        	    ...
	        	    update_post_meta($pid, 'email_key',$_POST['email_key']);
	        	    if(isset($_POST['locations']))
	        	    update_post_meta($pid, 'locations',$_POST['locations']);
	        	    if(isset($_POST['extra_css']))
	        	    update_post_meta($pid, 'extra_css',$_POST['extra_css']);
        	    }

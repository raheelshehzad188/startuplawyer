...
class Artist extends CI_Controller {
		...
		$this->url = base_url('/admin/artist');
		$this->load->model('auth_model');
    }
    //salesman
    private $single= 'Salesman';
    private $multi= 'Salesmans';
	...
	public function all()
	{
		...
		$data['breed']= $breed;
		$user = $this->session->userdata('knet_login');
		$data['data']= $this->modal->get(array('roleID'=>$this->roleID));
		// $data['dat']= $this->modal->get(array('roleID'=> $this->roleID,"created_by"=>$user->UserID,'status'=>0));
